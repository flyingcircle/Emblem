...
import com.charred.emblem.touch.LevelScroller;
...
public class LevelScene extends BaseScene {
    ...
    private void createLevelBoxes() {
        ...
        int width = com.charred.emblem.EmblemActivity.CAMERA_WIDTH;
        int height = com.charred.emblem.EmblemActivity.CAMERA_HEIGHT;
