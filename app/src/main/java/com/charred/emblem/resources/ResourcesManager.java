package com.charred.emblem.resources;

import android.graphics.Color;

import com.charred.emblem.EmblemActivity;
...
public class ResourcesManager {
    ...
    private EmblemActivity activity;
    ...
    public static void prepareManager(Engine engine, com.charred.emblem.EmblemActivity activity, ZoomCamera camera, VertexBufferObjectManager vbom) {
    ...
    public EmblemActivity getActivity() {
        return activity;
    }

    public void setActivity(EmblemActivity activity) {
