...
public class EmblemActivity extends BaseGameActivity {
    private static com.charred.emblem.EmblemActivity instance;
    ...
    public static com.charred.emblem.EmblemActivity getInstance() {
        return instance;
    }
